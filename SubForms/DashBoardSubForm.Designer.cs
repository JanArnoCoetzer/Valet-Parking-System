namespace Valet_Parking_System.SubForms
{
    partial class DashBoardSubForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableLayoutPanel3.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 20F));
            tableLayoutPanel3.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 20F));
            tableLayoutPanel3.Controls.Add(statusHotbarWidget, 0, 0);
            ...
            // statusHotbarWidget
            // 
            statusHotbarWidget.BackColor = Color.FromArgb(254, 254, 254);
            statusHotbarWidget.Dock = DockStyle.Fill;
            statusHotbarWidget.Location = new Point(0, 0);
            statusHotbarWidget.Margin = new Padding(0);
            statusHotbarWidget.Name = "statusHotbarWidget";
            statusHotbarWidget.Size = new Size(1520, 209);
            statusHotbarWidget.TabIndex = 0;
            // 
            // DashBoardSubForm
            // 
